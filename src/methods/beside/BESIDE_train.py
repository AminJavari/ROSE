...
from src.methods.beside.data_helper import signet_read_train_edge, BESIDE_tri_gen_batch, BESIDE_sta_gen_batch, \
    BESIDE_check_link_prediction_task, signet_read_edge_info

from src.methods.beside.BESIDE_model import BESIDE
...
def main(dataset_choose, mode_choose, emb_dim, epoch_num, dataset_train_fpath, dataset_test_fpath, dataset_nodes_fpath, out_fpath):
    # --- common arguments
    ...
    sub_log_fpath = '{}log.log'.format(out_fpath)
    out_emb_fpath = '{}emb.emb'.format(out_fpath)
    ...
    epoch_pkl_fpath = out_emb_fpath #'{}.ep{}'.format(out_emb_fpath, epoch_num)
    print('writing to {}'.format(epoch_pkl_fpath))
...
if __name__ == '__main__':
    ...
    try:
        dataset_choose = 'slashdot'
        mode_choose = 'tri_sta' #all, tri, sta
        emb_dim = 128
        epoch_num = 1
        
        dataset_train_fpath = './dataset/soc-sign-Slashdot090221.txt.map.train'
        dataset_test_fpath = './dataset/soc-sign-Slashdot090221.txt.map.test'
        dataset_nodes_fpath = './dataset/soc-sign-Slashdot090221.txt.map.nodes'
        model_dir = './emb/'
    ...
    main(dataset_choose, mode_choose, emb_dim, epoch_num, dataset_train_fpath, dataset_test_fpath, dataset_nodes_fpath, model_dir)
